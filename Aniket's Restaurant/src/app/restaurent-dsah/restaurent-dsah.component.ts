...
@Component({
  selector: 'app-restaurent-dsah',
  templateUrl: './restaurent-dsah.component.html',
  styleUrl: './restaurent-dsah.component.css'
})
export class RestaurentDsahComponent implements OnInit{
  formValue!:FormGroup;
